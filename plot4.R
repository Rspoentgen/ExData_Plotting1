...
plot(ecc4$complete.DateTime,ecc4$Sub_metering_1,type="l",col="black", xlab="",ylab="Energy sub metering")
lines(ecc4$complete.DateTime,ecc4$Sub_metering_2,type="l",col="red")
lines(ecc4$complete.DateTime,ecc4$Sub_metering_3,type="l",col="blue")
legend("topright",lty=1,col=c("black","red","blue"), bty="n",legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))


plot(ecc4$complete.DateTime,ecc4$Voltage, type="l" ,xlab="datetime", ylab="Voltage")

plot(ecc4$complete.DateTime,ecc4$Global_reactive_power, type="l" ,xlab="datetime", ylab="Global Reactive Power")
